...
namespace Practica4EDD2.util
{
    public class RSA
    {
        ...
        public static BigInteger Encrypt(BigInteger plaintext, BigInteger publicKey, BigInteger n)
        {
            // Cifrado: ciphertext = plaintext^publicKey mod n
            return BigInteger.ModPow(plaintext, publicKey, n);
        }
